...
%----------HEADING----------
\begin{center}
    \textbf{\Huge Ajay Saini} \\ \vspace{5pt}
    \small \faPhone* \texttt{+91-9891239146} \hspace{1pt} $|$
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{hi@ajaysaini.dev} \hspace{1pt} $|$ 
    \hspace{1pt} \faLinkedin \hspace{2pt} \texttt{sainiajay96} \hspace{1pt} $|$
    \hspace{1pt} \faMapMarker* \hspace{2pt}\texttt{Indian Citizen}
    \\ \vspace{-3pt}
\end{center}
...
\section{EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Deloitte Digital}{June. 2019 -- Dec. 2020}
      {Consultant}{Bangalore, KA}
      \resumeItemListStart
    ...
    \resumeSubheading
      {Tata Consultancy Services}{Aug. 2017 -- Jun. 2019}
      {Assistant Systems Engineer}{Gurgaon, HR}
      \resumeItemListStart
...
\section{SKILLS}
 \begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
     \textbf{Languages} {: JavaScript (Node.js), Golang, SQL (MySQL)}\vspace{2pt} \\
